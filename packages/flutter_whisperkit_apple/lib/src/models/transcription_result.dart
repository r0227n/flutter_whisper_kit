  ...
  factory TranscriptionSegment.fromJson(Map<String, dynamic> json) {
    return TranscriptionSegment(
      ...
      tokenLogProbs: json['tokenLogProbs'] != null 
          ...
          : [],
      temperature: json['temperature'] != null ? (json['temperature'] as num).toDouble() : 1.0,
      avgLogprob: json['avgLogprob'] != null ? (json['avgLogprob'] as num).toDouble() : 0.0,
      compressionRatio: json['compressionRatio'] != null ? (json['compressionRatio'] as num).toDouble() : 1.0,
      noSpeechProb: json['noSpeechProb'] != null ? (json['noSpeechProb'] as num).toDouble() : 0.0,
      words: json['words'] != null 
          ? (json['words'] as List).map((e) => WordTiming.fromJson(Map<String, dynamic>.from(e as Map))).toList() 
          : null,
    );
  }
...
class TranscriptionTimings {
  ...
  factory TranscriptionTimings.fromJson(Map<String, dynamic> json) {
    return TranscriptionTimings(
      pipelineStart: json['pipelineStart'] != null ? (json['pipelineStart'] as num).toDouble() : 0.0,
      firstTokenTime: json['firstTokenTime'] != null ? (json['firstTokenTime'] as num).toDouble() : 0.0,
      inputAudioSeconds: json['inputAudioSeconds'] != null ? (json['inputAudioSeconds'] as num).toDouble() : 0.001,
      modelLoading: json['modelLoading'] != null ? (json['modelLoading'] as num).toDouble() : 0.0,
      prewarmLoadTime: json['prewarmLoadTime'] != null ? (json['prewarmLoadTime'] as num).toDouble() : 0.0,
      encoderLoadTime: json['encoderLoadTime'] != null ? (json['encoderLoadTime'] as num).toDouble() : 0.0,
      decoderLoadTime: json['decoderLoadTime'] != null ? (json['decoderLoadTime'] as num).toDouble() : 0.0,
      encoderSpecializationTime: json['encoderSpecializationTime'] != null ? (json['encoderSpecializationTime'] as num).toDouble() : 0.0,
      decoderSpecializationTime: json['decoderSpecializationTime'] != null ? (json['decoderSpecializationTime'] as num).toDouble() : 0.0,
      tokenizerLoadTime: json['tokenizerLoadTime'] != null ? (json['tokenizerLoadTime'] as num).toDouble() : 0.0,
      audioLoading: json['audioLoading'] != null ? (json['audioLoading'] as num).toDouble() : 0.0,
      audioProcessing: json['audioProcessing'] != null ? (json['audioProcessing'] as num).toDouble() : 0.0,
      logmels: json['logmels'] != null ? (json['logmels'] as num).toDouble() : 0.0,
      encoding: json['encoding'] != null ? (json['encoding'] as num).toDouble() : 0.0,
      prefill: json['prefill'] != null ? (json['prefill'] as num).toDouble() : 0.0,
      decodingInit: json['decodingInit'] != null ? (json['decodingInit'] as num).toDouble() : 0.0,
      decodingLoop: json['decodingLoop'] != null ? (json['decodingLoop'] as num).toDouble() : 0.0,
      decodingPredictions: json['decodingPredictions'] != null ? (json['decodingPredictions'] as num).toDouble() : 0.0,
      decodingFiltering: json['decodingFiltering'] != null ? (json['decodingFiltering'] as num).toDouble() : 0.0,
      decodingSampling: json['decodingSampling'] != null ? (json['decodingSampling'] as num).toDouble() : 0.0,
      decodingFallback: json['decodingFallback'] != null ? (json['decodingFallback'] as num).toDouble() : 0.0,
      decodingWindowing: json['decodingWindowing'] != null ? (json['decodingWindowing'] as num).toDouble() : 0.0,
      decodingKvCaching: json['decodingKvCaching'] != null ? (json['decodingKvCaching'] as num).toDouble() : 0.0,
      decodingWordTimestamps: json['decodingWordTimestamps'] != null ? (json['decodingWordTimestamps'] as num).toDouble() : 0.0,
      decodingNonPrediction: json['decodingNonPrediction'] != null ? (json['decodingNonPrediction'] as num).toDouble() : 0.0,
      totalAudioProcessingRuns: json['totalAudioProcessingRuns'] != null ? (json['totalAudioProcessingRuns'] as num).toDouble() : 0.0,
      totalLogmelRuns: json['totalLogmelRuns'] != null ? (json['totalLogmelRuns'] as num).toDouble() : 0.0,
      totalEncodingRuns: json['totalEncodingRuns'] != null ? (json['totalEncodingRuns'] as num).toDouble() : 0.0,
      totalDecodingLoops: json['totalDecodingLoops'] != null ? (json['totalDecodingLoops'] as num).toDouble() : 0.0,
      totalKVUpdateRuns: json['totalKVUpdateRuns'] != null ? (json['totalKVUpdateRuns'] as num).toDouble() : 0.0,
      totalTimestampAlignmentRuns: json['totalTimestampAlignmentRuns'] != null ? (json['totalTimestampAlignmentRuns'] as num).toDouble() : 0.0,
      totalDecodingFallbacks: json['totalDecodingFallbacks'] != null ? (json['totalDecodingFallbacks'] as num).toDouble() : 0.0,
      totalDecodingWindows: json['totalDecodingWindows'] != null ? (json['totalDecodingWindows'] as num).toDouble() : 0.0,
      fullPipeline: json['fullPipeline'] != null ? (json['fullPipeline'] as num).toDouble() : 0.0,
    );
  }
  ...
  factory TranscriptionResult.fromJson(Map<String, dynamic> json) {
    return TranscriptionResult(
      ...
      timings: json['timings'] != null
          ...
          : TranscriptionTimings(),
      seekTime: json['seekTime'] != null ? (json['seekTime'] as num).toDouble() : null,
    );
  }
