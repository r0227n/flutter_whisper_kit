...
func deepEqualsWhisperKitApi(_ lhs: Any?, _ rhs: Any?) -> Bool {
  ...
  case let (cleanLhsArray, cleanRhsArray) as ([Any?], [Any?]):
    ...
    for (index, element) in cleanLhsArray.enumerated() {
      if !deepEqualsWhisperKitApi(element, cleanRhsArray[index]) {
        return false
      }
    }
    return true
  ...
  case let (cleanLhsDictionary, cleanRhsDictionary) as ([AnyHashable: Any?], [AnyHashable: Any?]):
    ...
    for (key, cleanLhsValue) in cleanLhsDictionary {
      ...
      if !deepEqualsWhisperKitApi(cleanLhsValue, cleanRhsDictionary[key]!) {
        return false
      }
    }
    return true
...
func deepHashWhisperKitApi(value: Any?, hasher: inout Hasher) {
  if let valueList = value as? [AnyHashable] {
     for item in valueList { deepHashWhisperKitApi(value: item, hasher: &hasher) }
     return
  }
  ...
  if let valueDict = value as? [AnyHashable: AnyHashable] {
    for key in valueDict.keys { 
      hasher.combine(key)
      deepHashWhisperKitApi(value: valueDict[key]!, hasher: &hasher)
    }
    return
  }
...
struct WhisperKitConfig: Hashable {
  ...
  static func == (lhs: WhisperKitConfig, rhs: WhisperKitConfig) -> Bool {
    return deepEqualsWhisperKitApi(lhs.toList(), rhs.toList())  }
  func hash(into hasher: inout Hasher) {
    deepHashWhisperKitApi(value: toList(), hasher: &hasher)
  }
}

/// Generated class from Pigeon that represents data sent in messages.
struct TranscriptionSegment: Hashable {
  var text: String
