  ...
  group('ErrorCode', () {
    group('getCategory', () {
      test('should categorize initialization errors correctly', () {
        ...
        expect(
          ErrorCategory.fromCode(ErrorCode.invalidConfiguration),
          equals(ErrorCategory.initialization),
        );
        expect(
          ErrorCategory.fromCode(ErrorCode.modelLoadingFailed),
          equals(ErrorCategory.initialization),
        );
        expect(
          ErrorCategory.fromCode(1999),
          equals(ErrorCategory.initialization),
        );
      });
      ...
      test('should categorize runtime errors correctly', () {
        ...
        expect(
          ErrorCategory.fromCode(ErrorCode.audioProcessingError),
          equals(ErrorCategory.runtime),
        );
      ...
      test('should categorize network errors correctly', () {
        expect(
          ErrorCategory.fromCode(ErrorCode.downloadFailed),
      ...
      test('should categorize permission errors correctly', () {
        ...
        expect(
          ErrorCategory.fromCode(ErrorCode.fileAccessDenied),
          equals(ErrorCategory.permission),
        );
      ...
      test('should categorize validation errors correctly', () {
        ...
        expect(
          ErrorCategory.fromCode(ErrorCode.invalidParameters),
          equals(ErrorCategory.validation),
        );
    ...
    group('getDescription', () {
      test('should return correct descriptions for initialization errors', () {
        ...
        expect(
          ErrorCode.getDescription(ErrorCode.insufficientMemory),
      ...
      test('should return correct descriptions for runtime errors', () {
        ...
        expect(
          ErrorCode.getDescription(ErrorCode.unsupportedAudioFormat),
      ...
      test('should return correct descriptions for network errors', () {
        expect(
          ErrorCode.getDescription(ErrorCode.downloadFailed),
          equals('Download failed'),
        );
        expect(
          ErrorCode.getDescription(ErrorCode.checksumMismatch),
      ...
      test('should return correct descriptions for permission errors', () {
        expect(
          ErrorCode.getDescription(ErrorCode.microphonePermissionDenied),
          equals('Microphone permission denied'),
        );
        expect(
          ErrorCode.getDescription(ErrorCode.storagePermissionDenied),
      ...
      test('should return correct descriptions for validation errors', () {
        expect(
          ErrorCode.getDescription(ErrorCode.audioTooShort),
          equals('Audio file too short'),
        );
        expect(
          ErrorCode.getDescription(ErrorCode.audioTooLong),
    ...
    group('isRecoverable', () {
      ...
      test('should identify non-recoverable errors', () {
        ...
        expect(
          ErrorCode.isRecoverable(ErrorCode.invalidConfiguration),
          isFalse,
        );
        expect(
          ErrorCode.isRecoverable(ErrorCode.microphonePermissionDenied),
          isFalse,
        );
    ...
    group('getSuggestedAction', () {
      test('should return appropriate actions for specific errors', () {
        expect(
          ErrorCode.getSuggestedAction(ErrorCode.modelNotFound),
          equals('Check model path or download the model'),
        );

        expect(
          ErrorCode.getSuggestedAction(ErrorCode.networkTimeout),
          equals('Check network connection and retry'),
        );
        expect(
          ErrorCode.getSuggestedAction(ErrorCode.networkUnavailable),
          equals('Check network connection and retry'),
        );
        ...
        expect(
          ErrorCode.getSuggestedAction(ErrorCode.insufficientMemory),
          equals('Free up memory or use a smaller model'),
        );

        expect(
          ErrorCode.getSuggestedAction(ErrorCode.invalidAudioFormat),
      ...
      test('should return default action for unspecified errors', () {
        expect(
          ErrorCode.getSuggestedAction(ErrorCode.transcriptionFailed),
          equals('Please check the error details and try again'),
        );
        expect(
          ErrorCode.getSuggestedAction(9999),
          equals('Please check the error details and try again'),
        );
      });
    });
