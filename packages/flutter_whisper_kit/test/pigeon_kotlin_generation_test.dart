...
void main() {
  ...
  final projectRoot =
      Directory.current.path.contains('packages/flutter_whisper_kit')
  ...
  group('Pigeon Kotlin Generation', () {
    test('should generate WhisperKitMessage.g.kt file after code generation',
        () {
      final kotlinFile = File(path.join(projectRoot,
          'packages/flutter_whisper_kit_android/android/src/main/kotlin/flutter_whisper_kit_android/WhisperKitMessage.g.kt'));
    ...
    test('should contain proper package declaration in generated Kotlin file',
      ...
      if (kotlinFile.existsSync()) {
        ...
        expect(content.contains('package flutter_whisper_kit_android'), isTrue,
            reason:
                'Generated Kotlin file should have correct package declaration');
      }
    });
    ...
    test('should contain WhisperKitMessage interface definition', () {
      ...
      if (kotlinFile.existsSync()) {
        ...
        expect(content.contains('interface WhisperKitMessage'), isTrue,
            reason:
                'Generated file should contain WhisperKitMessage interface');
  ...
  group('Pigeon Configuration Validation', () {
    test('should have kotlinOut configuration in whisper_kit_api.dart', () {
      final pigeonFile = File(path.join(projectRoot,
